Let us assume, we are presented with a fictional scenario, in which we need to build a Bloom filter to detect dangerous viral DNAs, given limited amount of storage.
